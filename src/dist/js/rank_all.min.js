...
$(".wrapper").addClass("fadein"),Api.getlistbyid({id:Common.getParameterByName("id")},function(t){1==t.status?(weixinshare({title1:"看我CEO测试高达"+t.msg.total+"分，实力碾压你的双商！",des:"用实力让情怀落地，用分数为自己说话",link:window.location.href,img:window.location.origin+"/src/images/share.jpg"},function(){}),$(".upload-wrap img").attr("src",t.msg.image),Common.gotoPin(0)):Common.alertBox.add(t.msg)}),t.bindEvent();for(var e=0;e<document.getElementsByTagName("img").length;e++)document.getElementsByTagName("img")[e].style.width=document.getElementsByTagName("img")[e].naturalWidth/100+"rem",document.getElementsByTagName("img")[e].style.height=document.getElementsByTagName("img")[e].naturalHeight/100+"rem"}})},t.prototype.bindEvent=function(){$(".btn-share").on("touchstart",function(){$(".share-pop").addClass("show")}),$(".share-pop").on("touchstart",function(){$(".share-pop").removeClass("show")}),$(".btn-scorelists").on("touchstart",function(){Common.gotoPin(8),Api.isLogin(function(t){t.info&&$("#form-contact").addClass("hasinfo")}),Api.rankList(function(t){if(1==t.status){for(var e="",n=0;n<t.list.length;n++)e=e+'<li class="item"><span class="num">'+n+'/</span><span class="name">'+t.list[n].nickname+'</span><span class="score">'+t.list[n].total+"</span></li>";$(".result-lists").html(e)}else Common.alertBox.add(t.msg)})}),$("#form-contact .btn-submit").on("touchstart",function(){$("#input-name").val()&&$("#input-mobile").val()?Api.submitInfo({name:$("#input-name").val(),info:$("#input-mobile").val()},function(t){1==t.status?$("#form-contact").addClass("hasinfo"):Common.alertBox.add(t.msg)}):Common.alertBox.add("请完善表单")}),$("#pin-result-lists .btn-close").on("touchstart",function(){Common.gotoPin(0)}),$("#pin-upload .btn-playagain").on("touchstart",function(){window.location.href=location.origin})},$(document).ready(function(){var e=new t;e.init()})}();