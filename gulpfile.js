...
var path = {
    ...
    welcomejs: ['./src/assets/js/lib/zepto.min.js','./src/assets/js/lib/reqAnimate.js','./src/assets/js/lib/pre-loader.js','./src/assets/js/lib/lrz.all.bundle.js','./src/assets/js/lib/fabric2.js','./src/assets/js/orientation.js','./src/assets/js/rem.js','./src/assets/js/common.js','./src/assets/js/controller.js'],
...
gulp.task("tinypng", function(){
    gulp.src(['./src/img-source/*.{png,jpg,jpeg}','./src/img-source/*/*.{png,jpg,jpeg}','./src/img-source/*/*/*.{png,jpg,jpeg}'])
        .pipe(tinypng({
